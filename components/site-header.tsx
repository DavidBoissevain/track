    ...
    <header className="flex items-center justify-between p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <a
          ...
          className="flex h-9 items-center gap-2 rounded-lg bg-yellow-400 px-4 py-2 font-semibold text-slate-900 shadow-md transition-all duration-200 hover:scale-105 hover:bg-yellow-500 hover:shadow-lg md:h-13"
        >
